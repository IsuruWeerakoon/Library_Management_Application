			...
			<div class="row">
				<div class="span12">
					...
					<div class="alert alert-success">
						<strong style="font-family: 'Arial Black', arial-black;font-size: 20px;"><i class="icon-book icon-large"></i>&nbsp;&nbsp;Details of Books Pending for Replacement</strong>
					...
					<ul class="nav nav-pills">
						...
						<li class="active"><a href="sub_rep.php">Books Pending for Replacement</a></li>
					</ul>
					<table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
						...
						<tbody>
                        <?php  $user_query = mysqli_query($connect,"select * from book where status = 'Pending for Replacement'")or die("Query Failed -> ".mysqli_error($connect));
                            while($row=mysqli_fetch_array($user_query)){
                                $id=$row['book_id'];
                                $cat_id=$row['category_id'];
                                $cat_query = mysqli_query($connect,"select * from category where category_id = '$cat_id'")or die(mysqli_error());
