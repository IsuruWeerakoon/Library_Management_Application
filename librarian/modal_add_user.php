<div id="add_user" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-body">
		<div class="alert alert-success"><strong>Register a new Librarian</strong></div>
...
<?php
    if (isset($_POST['submit'])){
        ...
        mysqli_query($connect,"insert into users (username,password,firstname,lastname) values('$username','$password','$firstname','$lastname')")or die("Query Failed -> ".mysqli_error($connect));
    }
?>