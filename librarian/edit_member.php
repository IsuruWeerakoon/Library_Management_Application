	...
	<div class="container">
		<div class="margin-top">
			<div class="row">
				<div class="span12">
                    <?php
                        $query = mysqli_query($connect,"select * from member where member_id='$get_id'")or die("Query Failed -> ".mysqli_error($connect));
                        $row=mysqli_fetch_array($query);
                    ?>
					<div class="alert alert-success"><i class="icon-edit icon-large"></i>&nbsp; Edit Member Details</div>
					...
					<div class="addstudent">
						...
						<form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="inputPassword" name="gender" disabled="disabled" value="<?php echo $row['gender']; ?>" placeholder="Gender" required>
								</div>
							</div>
							<div class="control-group">
