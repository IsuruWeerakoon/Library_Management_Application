			...
			<div class="row">
				<div class="span12">
					...
					<div class="alert alert-success">
						<strong style="font-family: 'Arial Black', arial-black;font-size: 20px;"><i class="icon-book icon-large"></i>&nbsp;&nbsp;Details of Books from Old Category</strong>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
						...
						<tbody>
                        <?php  $user_query = mysqli_query($connect,"select * from book where status = 'old'")or die("Query Failed -> ".mysqli_error($connect));
