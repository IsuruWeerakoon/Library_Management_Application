	...
	<div class="container">
		<div class="margin-top">
			<div class="row">
				<div class="span12">
                    <?php
                        $query = mysqli_query($connect,"select * from book LEFT JOIN category on category.category_id  = book.category_id where book_id='$get_id'")or die("Query Failed -> ".mysqli_error($connect));
                        $row=mysqli_fetch_array($query);
                        $category_id = $row['category_id'];
                    ?>
					<div class="alert alert-success"><i class="icon-edit icon-large"></i>&nbsp; Edit Book Details</div>
					...
					<div class="addstudent">
						...
						<form class="form-horizontal" method="POST" action="update_books.php" enctype="multipart/form-data">
							...
							<div class="control-group">
								<label class="control-label" for="inputPassword">Published Year:</label>
								<div class="controls">
