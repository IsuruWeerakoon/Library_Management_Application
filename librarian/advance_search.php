			...
			<div class="row">
				<div class="span12">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
						...
						<tbody>
                        <?php
                            $user_query = mysqli_query($connect,"select * from book where status != 'Archive' and book_title LIKE  '%$title%'
								  OR status != 'Archive' and author LIKE '%$author%'")or die("Query Failed -> ".mysqli_error($connect));
                            while($row=mysqli_fetch_array($user_query)){
								...
								<tr class="del<?php echo $id ?>">
									...
									<td class="action">
										...
										<a  rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="edit_book.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-edit icon-large"></i></a>
									</td>
								</tr>
                            <?php  }  ?>
						</tbody>
