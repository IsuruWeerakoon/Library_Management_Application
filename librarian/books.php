			...
			<div class="row">
				<div class="span12">
					...
					<div class="alert alert-success">
						<strong style="font-family: 'Arial Black', arial-black;font-size: 20px;"><i class="icon-book icon-large"></i>&nbsp;&nbsp;Details of all Registered Books</strong>
					...
					<p><a href="#add_book" class="btn btn-info" data-toggle="modal">&nbsp;Register a new Book </a></p>
				...
				<div class="span12">
					<table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
						...
						<tbody>
                        <?php
                            $user_query = mysqli_query($connect,"select * from book where status != 'Archived'")or die("Query Failed -> ".mysqli_error($connect));
                            while($row=mysqli_fetch_array($user_query)){
                                $id=$row['book_id'];
                                $cat_id=$row['category_id'];
                                $book_copies = $row['book_copies'];
                                $borrow_details = mysqli_query($connect,"select * from borrowdetails where book_id = '$id' and borrow_status = 'pending'");
