			...
			<div class="row">
				<div class="span12">
					...
					<div class="alert alert-success">
						<strong style="font-family: 'Arial Black', arial-black;font-size: 20px;"><i class="icon-book icon-large"></i>&nbsp;&nbsp;Details of Returned Books</strong>
